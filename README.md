...
- **สุ่มเพลงโดนใจ (Lucky Dip Random Song Generator)** — ปุ่มสุ่มเพลงจากคลัง 1,500 เพลง (หรือสุ่มจากผลลัพธ์การค้นหาปัจจุบัน) เหมาะสำหรับผู้ใช้ที่นึกไม่ออกว่าจะร้องเพลงอะไร
...
- **ประวัติการค้นหาล่าสุด (Recent Search History)** — จดจำคำค้นหาล่าสุด 5 รายการผ่าน `localStorage` แตะเพื่อค้นหาซ้ำได้ทันที รองรับการลบทีละรายการและล้างประวัติทั้งหมด
- **คำค้นหายอดนิยม (Quick Discovery Tags)** — แท็กคำค้นหายอดนิยมและศิลปินชั้นนำ (เช่น `#ขอใจกันหนาว`, `#ต่าย อรทัย`, `#ดอกหญ้าในป่าปูน`, `#มนต์แคน แก่นคูน`, `#คิดฮอด`, `#กำลังใจ`) แตะปุ๊บค้นหาและเลื่อนไปยังผลลัพธ์อัตโนมัติ
